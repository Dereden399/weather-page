...
const WeatherInfo = () => {
  ...
  return (
    <div className='h-full w-full flex flex-col items-center justify-start'>
      <div
        className='bg-mainColor-500/80 rounded-2xl flex flex-col items-center justify-start h-[calc(100vh-4rem)] w-full mt-4
      ...
      >
        <div className='flex flex-col lg:basis-7/12 lg:h-full w-full'>
          <div className='flex flex-row items-center justify-between w-full p-1 md:p-2 h-auto'>
            ...
            <div className='flex flex-col justify-center w-full'>
              ...
              <p className='text-sm text-mainColor-200 md:text-2xl'>
                {data.sys.country}
              </p>
            </div>
          ...
          <div className='h-full max-h-full w-full flex flex-col justify-start bg-mainColor-300/80 p-3 md:p-5 lg:bg-mainColor-700/80 lg:rounded-bl-2xl lg:text-lg'>
            <div className='flex flex-row justify-start items-center pl-2'>
              ...
              <div className='flex flex-col w-full justify-start ml-3'>
                ...
                <i className='text-mainColor-100 text-2xl md:text-4xl lg:text-3xl'>
                  {data.weather[0].description}
                </i>
              </div>
            </div>
            <p className='text-lg text-mainColor-100 md:text-4xl lg:text-2xl'>
              Feels like {Math.floor(data.main.feels_like)}°C
            </p>
            <p className='text-lg text-mainColor-100 font-bold md:text-4xl lg:text-xl lg:font-normal'>
        ...
        <div className='h-full w-full flex flex-col justify-start overflow-y-auto scrollbar overflow-hidden bg-mainColor-300/80 rounded-b-2xl lg:basis-5/12 lg:rounded-tr-2xl lg:rounded-bl-none lg:overflow-y-hidden'>
          <div className='h-auto w-full grid grid-cols-2 grid-rows-5 px-2 mb-2 items-center gap-x-1 gap-y-2 md:grid-cols-6 md:grid-rows-3 md:h-full md:my-12 md:gap-x-4 md:gap-y-10 lg:grid-rows-5 lg:grid-cols-2 lg:gap-y-2 lg:px-4 lg:py-8 lg:my-0'>
            ...
            <div className='weatherPanel md:col-span-2 lg:col-span-1'>
              <IoIosWater className='h-16 w-16 fill-mainColor-700 md:h-[4.5rem] md:w-[4.5rem]' />
            ...
            <div className='weatherPanel col-span-2 justify-start md:col-span-3 lg:col-span-2'>
              <WiSunrise className='h-16 w-16 fill-mainColor-700 md:h-[4.5rem] md:w-[4.5rem]' />
            ...
            <div className='weatherPanel col-span-2 justify-start md:col-span-3 lg:col-span-2'>
              <WiSunset className='h-16 w-16 fill-mainColor-700 md:h-[4.5rem] md:w-[4.5rem]' />
              <div className='flex flex-col items-start ml-2 md:text-2xl'>
